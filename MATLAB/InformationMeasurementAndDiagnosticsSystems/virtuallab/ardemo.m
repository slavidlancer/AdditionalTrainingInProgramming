...
case 'ToggleButton'
   ...
   switch PropSetting
   case 'manual'
      eval(['set(findobj(gcf,''Tag'',''ActiveAxes''),''',PropName,'Mode'',''manual'');'])
   ...
   case 'auto'
      ...
      eval(['set(findobj(gcf,''Tag'',''ActiveAxes''),''',PropName,'Mode'',''auto'');'])
      ardemo('Refresh');
...
case 'SetProperty'
   ...
   eval(['set(findobj(gcf,''Tag'',''ActiveAxes''),''',PropName,''',',mat2str(newval),')']);
