...
%   $Revision: 1.10 $ $Date: 1998/04/14 11:53:09 $
...
if ~isempty(QuatFig),
  ...
  Data.FastDrawFig=Data.FastDrawFig(ishandle(Data.FastDrawFig));  
  
  % Don't flash the watch during simulation  
  if nargin~=4,  
    set([Data.FastDrawFig Data.QuatFig],'Pointer','watch');      
  end    
  ...
  case 1,
    ...
    switch Action,
      case 'Close',
        ...
        delete([Data.FastDrawFig Data.QuatFig]);      
      ...
      case 'FastDrawOpen',
        set(Data.QuatFig,'Renderer','painters');      
        set(Data.QuatAxes,'Parent',Data.FastDrawFig,'Position',[0 0 1 1]);
        set([Data.FastDrawFig QuatFig],'Units','points');
        FigPos=get(QuatFig,'Position');        
        set(Data.FastDrawFig, ...
            'Position'       ,[FigPos(1:2)+[50 FigPos(4)-250] 200 200], ...
            'Visible'        ,'on'                                      ...
            );
        
        set(Data.QuatFig,'HandleVisibility','on');
        figure(Data.QuatFig)
        rotate3d off
        set(Data.QuatFig,'HandleVisibility','callback');
        
        set(Data.FastDrawFig,'HandleVisibility','on');
        figure(Data.FastDrawFig)
        rotate3d on
        set(Data.FastDrawFig,'HandleVisibility','callback');
        
        set(Data.FastDrawCheck,'Callback','quatdemo FastDrawClose','Value',1);
                
      case 'FastDrawClose',
        set(Data.QuatAxes,'Parent',Data.QuatFig,'Position',Data.QuatAxesPos);
        set(Data.QuatFig,'Renderer','zbuffer');      
        set(Data.FastDrawCheck,'Callback','quatdemo FastDrawOpen','Value',0);
...
Data.QuatFig=Data.QuatFig(ishandle(Data.QuatFig));
Data.FastDrawFig=Data.FastDrawFig(ishandle(Data.FastDrawFig));
set([Data.FastDrawFig Data.QuatFig],'Pointer','arrow');      
...
while ~DrawFlag,
  ...
  set(Data.DynamicButton,'UserData',logical(1));
  ...
  if strcmp(Caller,'Figure'),
    ...
    if IsDynamic,
      if ~(P==0 & Q==0 & R==0),
        ...
        set(Data.DynamicButton,'UserData',logical(0));
  ...
  if strcmp(get(Data.FastDrawFig,'Visible'),'on'),  
    figure(Data.FastDrawFig)  
  end   
end % while ~DrawFlag
...
FastDrawPos=ResetPos;
FastDrawPos(2)=FramePos(1,2);
...
FastDrawFig=copyobj(QuatFig,0);
set(FastDrawFig     , ...
   'Position'       ,[FigPos(1:2)+[50 FigPos(4)-250] 200 200], ...
   'Menubar'        ,'none'                                  , ...   
   'Tag'            ,'Quaternion FastDraw Fig'               , ...   
   'CloseRequestFcn','quatdemo FastDrawClose'                  ...
   );
...
FastDrawCheck=uicontrol(UIInfo   , ...
                       'Style'   ,'Checkbox'             , ...
                       'String'  ,'Fast Render'          , ...
                       'Tag'     ,'Fast Render'          , ...
                       'Position',FastDrawPos            , ...
                       'Callback','quatdemo FastDrawOpen'  ...
                       );
...
Data.FastDrawCheck=FastDrawCheck;
Data.FastDrawFig=FastDrawFig;
Data.Frames=Frames;
...
FastFigData.QuatFig=QuatFig;
set(FastDrawFig,'UserData',FastFigData);
