...
%   input arguments.                                 
%
%   The Command Window in the lower                  
%   left shows the list of commands that create      
...
%   $Revision: 5.7 $  $Date: 1997/11/21 23:25:49 $
...
if strcmp(action,'initialize'),
    ...
    labelHt=0.05;
    spacing=0.005;
    promptStr=strvcat(' ',' % Press the buttons at the right to see', ...
