...
categoryNames = {'matlab' 'toolboxes' 'simulink' 'stateflow' 'blocksets'};
...
chooseMsg = 'Choose a sub-topic to see a list of demos';
...
elseif strcmp(action,'initialize'),
   ...
   fourthExist = exist('fourthinfo.m','file');
   
   if fourthExist 
      fourthList = fourthinfo;
   else
      fourthList = {};
   end
...
about2= {...
   ...
   ' work you do.                                  '};
about5=...
   {'Stateflow provides a complete environment in   '
   ' which you can model all types of reactive      '
   ' systems.  It works closely with Simulink to    '
   ' provide a complete system simulation           '
   ' environment.                                   '
   '                                                '
   ' In addition, Stateflow can produce efficient   '
   ' production-quality code so that you can turn   '
   ' your thoughts and ideas into real systems.     '
   '                                                '};
