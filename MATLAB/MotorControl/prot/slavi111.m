function [ret,x0,str,ts,xts]=slavi111(t,x,u,flag);
%SLAVI111	is the M-file description of the SIMULINK system named SLAVI111.
%	SLAVI111 has a the following characteristics:
%		7 continuous states
%		27 discrete states
%		0 outputs
%		0 inputs
...
%		1 sample times
%
%	The block-diagram can be displayed by typing: SLAVI111.
%
%	SYS=SLAVI111(T,X,U,FLAG) returns depending on FLAG certain
%	system values given time point, T, current state vector, X,
%	and input vector, U.
%	FLAG is used to indicate the type of output to be returned in SYS.
%
%	Setting FLAG=1 causes SLAVI111 to return state derivatives, FLAG=2
%	discrete states, FLAG=3 system outputs and FLAG=4 next sample
%	time. For more information and other options see SFUNC.
%
%	Calling SLAVI111 with a FLAG of zero:
%	[SIZES]=SLAVI111([],[],[],0),  returns a vector, SIZES, which
