function [ret,x0,str,ts,xts]=slavi19(t,x,u,flag);
%SLAVI19	is the M-file description of the SIMULINK system named SLAVI19.
%	The block-diagram can be displayed by typing: SLAVI19.
%
%	SYS=SLAVI19(T,X,U,FLAG) returns depending on FLAG certain
%	system values given time point, T, current state vector, X,
%	and input vector, U.
%	FLAG is used to indicate the type of output to be returned in SYS.
%
%	Setting FLAG=1 causes SLAVI19 to return state derivatives, FLAG=2
%	discrete states, FLAG=3 system outputs and FLAG=4 next sample
%	time. For more information and other options see SFUNC.
%
%	Calling SLAVI19 with a FLAG of zero:
%	[SIZES]=SLAVI19([],[],[],0),  returns a vector, SIZES, which
