...
{
    public sealed class Earth : ElementalObject, IEarth
    {
        public Earth(string name, int age, ColorType color, SizesMeasures sizes, byte personalNumber,
	    ...
	    {
            var earthAllInfo = new StringBuilder();
